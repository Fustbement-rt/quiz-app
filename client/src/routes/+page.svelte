...
<Subtitle>Füstbement rt.</Subtitle>
<Content>
	<div>
		<b>Mi az a flashcard</b>
		<p>
		...
		<b>Mi az alkalmazásunk előnye</b>
		<p>
		...
		<ol>
			<li>
				Aktív tanulás: A quiz rész lehetővé teszi, hogy aktívan teszteld
			...
			<li>
				Passzív tanulás: A flashcardok pedig a passzív tanulásra
			...
			<li>
				Változatosság: Az alkalmazásban a quiz és a flashcardok
			...
			<li>
				Fejlődés nyomon követése: Az alkalmazás nyomon követi a
			...
			<li>
				Rugalmasság: Az alkalmazások általában mobiltelefonokon,
